...
//ここまでテーブル加工記述
	...
	this.setArgumentObj = function(clickRowData, create_tag) {
		...
		var argumentObj = $.extend(true, {}, this.getDefaultArgumentObject());
	...
	this.cancelUpdateJson = function(dialogClass, create_tag){
		...
		var retObj = this.createCloneObject(dialogClass.getArgumentDataObject());
		//クエリをセットする
	...
	this.cancelExecute = function() {
		//キャンセル処理を実装する
		commonFuncs.registerReserved(this.instance, this.instance.argumentObj.data.create_tag, this.dialogBuilder);
	}
