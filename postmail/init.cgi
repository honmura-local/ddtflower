...
# メール件名（初期値）
$cf{subject} = "DDTフラワーズ　体験レッスン予約希望メール";
$cf{subject_reply} ="DDTフラワーズ　体験レッスンの予約希望を承りました。";
...
# メール概要（初期値）
$cf{summary} = "DDTフラワーズ　体験レッスン予約希望メール";
$cf{summary_reply} ="DDTフラワーズ　体験レッスンの予約希望を承りました。";

#各フォーム毎のメールの概要
$cf{multi_summary} = {
		1 => "以下の内容でお問い合わせをいただきました。",
